    ...
    if ($resultado_check_usuario->num_rows > 0) {
        ...
        if (!$stmt_usuario->execute()) {
            ...
            if (!$stmt_agente->execute()) {
                $mensaje_error = "Error al actualizar agente: " . $stmt_agente->error;
            } else {
                        ...
                        <form method="POST" class="pt-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="nombre_completo" class="form-control form-control-lg"
                                    placeholder="Nombre Completo" value="<?php echo htmlspecialchars($_SESSION['nombre']); ?>" readonly>
                            </div>
                            <div class="form-group">
